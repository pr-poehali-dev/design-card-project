...
const Hero = () => {
  return (
    <section className="relative bg-gradient-brand min-h-screen flex items-center overflow-hidden">
      ...
      <div className="absolute inset-0 bg-[url('data:image/svg+xml,%3Csvg width="40" height="40" viewBox="0 0 40 40" xmlns="http://www.w3.org/2000/svg"%3E%3Cg fill="white" fill-opacity="0.1"%3E%3Ccircle cx="20" cy="20" r="2"/%3E%3C/g%3E%3C/svg%3E')] opacity-30"></div>
        ...
        <div className="grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div className="text-white animate-fade-in">
            <h1 className="text-4xl md:text-6xl font-bold leading-tight mb-6">
              ...
              <span className="text-yellow-300">300%</span> с дизайном карточек
            </h1>
              ...
              <div className="bg-white rounded-2xl p-8 shadow-2xl transform rotate-3 hover:rotate-0 transition-transform duration-500">
                <div className="bg-gradient-to-br from-gray-100 to-gray-200 rounded-xl h-80 flex items-center justify-center">
                  <div className="text-center">
                    <Icon name="ShoppingCart" size={64} className="text-brand-blue mx-auto mb-4" />
